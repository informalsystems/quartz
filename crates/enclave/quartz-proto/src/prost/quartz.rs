...
pub mod core_server {
    ...
    #[async_trait]
    pub trait Core: std::marker::Send + std::marker::Sync + 'static {
    ...
    pub const SERVICE_NAME: &str = "quartz.Core";
    impl<T> tonic::server::NamedService for CoreServer<T> {
