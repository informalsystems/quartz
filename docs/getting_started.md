...
## Local wasmd Testnet Without SGX
...
to be the contract address and pubkey from the previous step. With quartz dev, they can be grabbed
...
you won't have to use it if you don't clear your browser storage.
