...
//     let transfers_service = TransfersService::new(config.clone(), sk.clone(), attestor.clone(), tx);
...
//     tokio::select! {
//         ws_result = ws_listener_handle => {
//             ws_result.expect("WebSocket listener task failed");
//         }
//         quartz_result = quartz_server_handle => {
//             quartz_result.expect("QuartzServer task failed")?;
//         }
//     }
